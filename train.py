...
def main(config):
    ...
    joblib.dump(train_dataset.feature_scaler, f'feature_scaler_{config["MODEL_TYPE"]}_{config["BATCH_SIZE"]}.joblib')
    joblib.dump(train_dataset.target_scaler, f'target_scaler_{config["MODEL_TYPE"]}_{config["BATCH_SIZE"]}.joblib')
